...
import java.util.*;
//creating class for execution process
class Day{
	//Declaring method to do function
	public String Program(int year) {
		//check whether the year less than 1918 because of Julian calendar
if(year>1918){
	//to find leap year
         return (year%4==0 && year%100!=0 || year%400==0)? "12.09."+year : "13.09."+year; 
    }
	//In 1918 the calendar changes so add plus 14 days
	else if(year==1918){
        return "26.09."+year;
    }
	// below 1918 Julian calendar so different execution
...
public class DayoftheProgrammer {
	...
	public static void main(String[] args) {
		...
		System.out.print("Enter the year to make time travel : ");
		//Intitalizing the year to make calculation
		int year=in.nextInt();
		//creating object for Day class
		Day day=new Day();
		System.out.print("you will travel to : ");
		System.out.print(day.Program(year));
	}
