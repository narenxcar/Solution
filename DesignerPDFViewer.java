...
7*4
7 is maximum element in string of array
4 is string length
		 ...
		 int[] array=new int[26];
	      ...
	      System.out.println("Enter the array elements : ");
	       ...
	       System.out.println("Enter the string : ");
	        String word=in.next();
	       Pdf result=new Pdf();
	       System.out.print("The  highlighted area are : ");
	       System.out.println(result.designerPdfViewer(array,word));
	    }
	}
