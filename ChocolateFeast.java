...
public class ChocolateFeast {
	...
	public static void main(String[] args) {
		...
		System.out.print("Enter the cost of choccolate : ");
		int cost=in.nextInt();
		System.out.print("number of wrapper for a chocolet : ");
		int recycle=in.nextInt();
		int n=money/cost,total=0,rem=0;
		while(n>0){
	        total+=n;
	        rem+=n;
	        n=rem/recycle;
		...
		System.out.print("Total number of chocolet the boy eat : ");
